          ...
          <ul class="popular-list">
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-img">
                  <img src="{{asset('images/popular-1.jpg')}}" alt="San miguel, italy" loading="lazy">
                </figure>
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-img">
                  <img src="{{asset('images/popular-2.jpg')}}" alt="Burj khalifa, dubai" loading="lazy">
                </figure>
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-img">
                  <img src="{{asset('images/popular-3.jpg')}}" alt="Kyoto temple, japan" loading="lazy">
                </figure>
